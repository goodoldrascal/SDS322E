...
**We wanted to determine whether injuries resulting from a car crash could be reliably predicted from variables not directly associated injury. In order to make optimize our models performance we decided to create a new binomial variable with a value or TRUE for any nonzero injury count and FALSE for an injury count of zero. The number of injury associated crashes was highly represented in our dataset, with approximately forty-five percent of the samples with nonzero injury counts. **
