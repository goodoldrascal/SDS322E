...
summary(train |> select(latitude, longitude, crash_speed_limit, onsys_fl, private_dr_fl, point))

rec <- recipe(injury ~ latitude + longitude + crash_speed_limit + onsys_fl + units_involved + road_constr_zone_fl + hour + wday + month + `Estimated Maximum Comprehensive Cost`, data = train)
